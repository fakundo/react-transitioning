...
@param done - A callback function to signal that the phase is complete.`,name:"addEndListener",required:!1,type:{name:"((phase: TransitionPhase, done: () => void) => void)"}}}}}catch{}const c={tags:["!dev"]},n={render:()=>{const[t,o]=l.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:()=>o(!t),type:"button",children:"Toggle visibility"}),e.jsx("hr",{}),e.jsx(a,{in:t,alwaysMounted:!0,children:e.jsx("div",{style:{width:100,height:100,borderRadius:"15%",background:"linear-gradient(to bottom right, seagreen, teal)"}})})]})}};var i,r,s;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: () => {
...
}`,...(s=(r=n.parameters)==null?void 0:r.docs)==null?void 0:s.source}}};const m=["Default"];export{n as Default,m as __namedExportsOrder,c as default};
